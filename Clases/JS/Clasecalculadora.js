...
//Click al Signo (+.-,*,/)
  ...
  {
    case '+':
    document.getElementById('resultado').innerHTML=claseinstanciada.Sumar(); //LLamar a la operacion de suma
    break;
    case '-':
    document.getElementById('resultado').innerHTML=claseinstanciada.Restar(); //LLamar a la operacion de resta
    break;
    case 'X':
    document.getElementById('resultado').innerHTML=claseinstanciada.Multiplicar(); //LLamar a la operacion de multiplicacion
    break;
    case '/':
    document.getElementById('resultado').innerHTML=claseinstanciada.Dividir(); //LLamar a la operacion de division
    break;
    default:
    break;
  }
